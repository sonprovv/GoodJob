            ...
            try {
                ...
                if (userID != null) {
                    ...
                    when (jobsResponse) {
                        ...
                        is NetworkResult.Error -> {
                            Log.e(
                                "HistoryPaymentViewModel",
                                "Error fetching user jobs: ${jobsResponse.message}"
                            )
                        }
                    }
                } else {
                    Log.e("HistoryPaymentViewModel", "No userID found in payments")
                }
            } catch (e: Exception) {
                Log.e("HistoryPaymentViewModel", "Error in fetchJobLocations: ${e.message}")
            } finally {
                _loading.value = false
